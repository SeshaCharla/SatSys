...
The values of the Wald test statistic for each drive segment that met the necessary condition of sufficient samples close
to catalyst saturation are calculated and tabulated in Tables~\ref{tab::adt_aging_res}, \ref{tab::mes_aging_res},
