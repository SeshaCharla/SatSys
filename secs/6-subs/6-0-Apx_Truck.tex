...
to catalyst saturation is calculated and tabulated in Tables~\ref{tab::adt_aging_res}, \ref{tab::mes_aging_res},
\ref{tab::wer_aging_res} and, \ref{tab::trw_aging_res} for Trucks A, B, C, and D, respectively. The number and percentage of samples close to
catalyst saturation in each drive segment is also tabulated. There is a strong correlation between aging detection and
the number of samples close to catalyst saturation in the drive segment. In each table, the entries above the horizontal rule correspond to the earlier data year and those below correspond to the latter data year (Table~\ref{tab::truck_data_summary}).
%===
% Truck Mapping
...
\begin{table}[H]
        \centering
        \caption{Aging Detection in Truck~A}
...
\begin{table}[H]
        \centering
        \caption{Aging Detection in Truck~B}
...
\begin{table}[H]
        \centering
        \caption{Aging Detection in Truck~C}
...
\begin{table}[H]
        \centering
        \caption{Aging Detection in Truck~D}
