...
(Figure~\ref{fig::alpha_sat_ssd},\ref{fig::alpha_sat_iod})between aged and degreened catalysts. But the overall trend of
change in parameter values remains consistent.
%===
\begin{table}[H]
        \centering
