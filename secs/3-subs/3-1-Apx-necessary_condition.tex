\section{Necessary Conditions for Catalyst Mode Detection \label{sec::necessary_cond}}
...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.4\textwidth]{./figs/3_cat_mode/eta_sim.eps}
        \caption{RMC Test $NO_x$ Reduction with $\pm 20$ Urea Dosing Gain Variation}
        \label{fig::necessary_cond_sim}
\end{figure}
\begin{figure}[H]
        \centering
        \includegraphics[width=0.4\textwidth]{./figs/3_cat_mode/eta_sat.eps}
