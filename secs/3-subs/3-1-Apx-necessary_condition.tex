...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.4\textwidth]{./figs/3_parm_ID/apx_necessary/eta_sim.png}
        \caption{RMC Test $NO_x$ Reduction with $\pm 20$ Urea Dosing Gain Variation}
        \label{fig::necessary_cond_sim}
\end{figure}
\begin{figure}[H]
        \centering
        \includegraphics[width=0.4\textwidth]{./figs/3_parm_ID/apx_necessary/eta_sat.png}
