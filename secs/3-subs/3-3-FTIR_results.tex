...
significantly between RMC and hot-FTP tests. This is predominately due to the differences in the temperature ranges
experienced by the catalyst during the tests, which affects the Arrhenius temperature dependence of the rate constant
and the concentration of viable voids on the catalyst surface. The temperature range of the data considered during the
RMC tests is between 240°C and 360°C, while for the Hot-FTP tests it is between  200°C and 300°C.
\begin{table}[ht]
        \centering
