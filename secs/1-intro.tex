...
the catalyst reduces with time due to hydrothermal aging and deposition of contaminants such as excess urea, platinum,
...
cross-sensitivity to ammonia. Finally, we develop a statistical test for detecting the catalyst aging based on the
