...
Continuously Stirred Tank Reactors (CSTRs) approximation (\cite{hsieh2011development} , and \cite{nova2014urea}). The
...
\cite{charla2026board} of the reactants, resulting in high sampling frequency requirements that are not feasible in
