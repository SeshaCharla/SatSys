...
sulfur and phosphorus \cite{matsumoto2016model}. The aging of the catalyst leads to increased emissions of $NO_x$ and
...
Numerous studies have been conducted on modeling SCR-ASC systems and their control \cite{yuan2015diesel}. A
...
aging based on the tailpipe $NO_x$ and ammonia is proposed in \cite{matsumoto2016model} based on the hypothesis of
