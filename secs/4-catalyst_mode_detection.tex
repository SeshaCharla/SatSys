...
A fraction of the data from the test-cell experiments under RMC and Hot-FTP test conditions for both degreened and aged catalysts are found to be in saturated mode. The number and percentage of data points classified as close to catalyst saturation (or at the maximum $NO_x$ reduction) for different test conditions is tabulated in Table-\ref{tab::sat_data_perc_ssd}, \ref{tab::sat_data_perc_iod}.
%==============================================================
\begin{table}[H]
        \centering
        \caption{Data Points Close to Catalyst Saturated Mode in Test-Cell FTIR Data}
        \label{tab::sat_data_perc_ssd}
        \begin{tabular}{l c c}
                \hline \hline
                Test & Total Data & Catalyst Saturation \\\hline \hline
                DG RMC 1  & 2402 & 490  \\
                DG RMC 2  & 2402 & 493  \\
                DG RMC 3  & 2402 & 491  \\
...
\begin{table}[H]
        \centering
        \caption{Data Points Close to Catalyst Saturated Mode in Test-Cell $NO_x$ Sensor Data}
        ...
        \end{tabular}
\end{table}
A higher number of data points classified as close to catalyst saturation in RMC test conditions compared to Hot-FTP,
this results in better parameter estimates and performace of the aging detection test statistic
