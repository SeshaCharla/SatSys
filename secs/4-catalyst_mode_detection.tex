...
based on the cumulative distribution of the prediction error for the saturated catalyst model across all the test-cell
data such that the probability of a data point being classified as close to catalyst saturation is greater than $68.2\%$
for the test-cell data.
\begin{figure}[H]
        \centering
