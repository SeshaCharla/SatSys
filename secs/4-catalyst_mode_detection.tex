...
catalysts are found to be in saturated mode. The number data points close to catalyst saturation $\lr{N_{sat}}$ and the
total number of samples ($N$) for different test conditions is tabulated in Table-\ref{tab::sat_data_perc_ssd},
