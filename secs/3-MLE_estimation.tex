...
be an exponential random variable. The assumption of half-normal distribution for $\varepsilon_\eta$ implies that the
catalyst close to saturated for most of the time. Ideally this would be one of the objectives of the closed-loop
urea-dosing controller as maximum $NO_x$ reduction is achieved when the catalyst is saturated.
