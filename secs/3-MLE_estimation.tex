...
\end{align}
%===
The above optimization problem is feasible as $\eta_{sat}, \eta \geq 0$ always. When the $NO_x$ sensor data is used,
$\eta(k)$ is replaced with $\eta_y(k)$ as the bounding condition still holds (\ref{eqn::eta_y_bound}) . Rewriting
