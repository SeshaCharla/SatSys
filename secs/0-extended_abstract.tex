...
the $\nox$ reduction, $\eta(k) = u_1(k-1) - x_1(k)$ where $u_1$ is inlet and
$x_1$ is outlet $\nox$, becomes independent of urea dosing. The $\nox$
...
$\Gamma(T)$. Thus, the $\nox$ reduction in the saturated mode, $\eta_{sat}$, is
...
crucial observation is that the $\nox$ reduction under saturation,
$\eta_{sat}(k)$, forms a tight upper bound for the actual $\nox$ reduction,
