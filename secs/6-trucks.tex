...
\begin{table}[ht]
        ...
        \hline \hline
               & Earlier Data & Latter Data & Mileage \\
...
and missed detection rates. The AD Transport truck has relatively lower mileage difference between the earlier and
latter data years which may explain the lower detection performance. The performance is limited by the amount of data
available with sufficient samples close to catalyst saturation. Further, the lack of ground truth on the actual catalyst
